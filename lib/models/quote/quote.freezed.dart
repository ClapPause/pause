...
class _$QuoteImpl implements _Quote {
  const _$QuoteImpl({required this.id, required this.title});
  ...
  @override
  String toString() {
    return 'Quote(id: $id, title: $title)';
  }
...
abstract class _Quote implements Quote {
  const factory _Quote({required final int id, required final String title}) =
      _$QuoteImpl;
